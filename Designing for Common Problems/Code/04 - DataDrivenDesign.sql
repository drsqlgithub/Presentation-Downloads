...
if exists (select * from sys.databases where name = 'Patterns_DataDrivenSales')
 exec ('
alter database  Patterns_DataDrivenSales
	set single_user with rollback immediate;

drop database Patterns_DataDrivenSales;')


create database Patterns_DataDrivenSales
Go
use Patterns_DataDrivenSales
GO
...
VALUES	('00001','Beeg','Speender'),
		('00002','Lotso','Spendingbear'),
		('00003','Po','Urr'),
		('00004','Owen','Lott')
GO
SELECT *
...
SELECT	customer.customerNumber, customer.firstName, customer.LastName, 
		customerClassification.customerType
FROM   sales.customer
...
--But this is clearly not the "best" way to implement settings such as this, but all too often you see code
