...
ALTER TABLE Messages.ShortMessage
  ADD CONSTRAINT ShortMessage$References$Account$$ForFromAccountId
	  FOREIGN KEY (FromAccountId) REFERENCES Attendees.Account(AccountId) ON DELETE NO ACTION;

ALTER TABLE Messages.ShortMessage
  ADD CONSTRAINT ShortMessage$References$Account$$ForToAccountId
	  FOREIGN KEY (ToAccountId) REFERENCES Attendees.Account(AccountId) ON DELETE NO ACTION;
GO
...
VALUES (1,1,2,'Hi'),(2,3,4,'Hello'),(3,5,6,'Sup?'),(4,6,NULL,'You are all crazy')
GO
