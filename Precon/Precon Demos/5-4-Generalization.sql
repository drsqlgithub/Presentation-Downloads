...
if exists (select * from sys.databases where name = 'GeneralizationDemo')
 exec ('
alter database  GeneralizationDemo
	set single_user with rollback immediate;

drop database GeneralizationDemo;')

CREATE DATABASE GeneralizationDemo; --uses basic defaults from model databases
GO
USE GeneralizationDemo;
GO
