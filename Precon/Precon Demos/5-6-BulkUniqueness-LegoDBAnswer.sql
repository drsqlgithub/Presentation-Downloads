...
if exists (select * from sys.databases where name = 'BigKidInventory')
 exec ('
alter database  BigKidInventory
	set single_user with rollback immediate;

drop database BigKidInventory;')

CREATE DATABASE BigKidInventory; --uses basic defaults from model databases
GO
USE BigKidInventory;
GO
...
--show inventory of pieces, grouped by Piece.Type,Piece.Color, Piece.Height, Piece.Width, Piece.Length
--and also totalled
