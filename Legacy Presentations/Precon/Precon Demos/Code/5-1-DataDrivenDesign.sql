...
if exists (select * from sys.databases where name = 'DataDrivenSales')
 exec ('
alter database  DataDrivenSales
	set single_user with rollback immediate;

drop database DataDrivenSales;')


create database DataDrivenSales
Go
use dataDrivenSales
GO
...
--Model starts here, reverse engineer from here o
